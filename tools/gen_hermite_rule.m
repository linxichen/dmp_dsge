function gen_hermite_rule ( order, alpha, a, b, filename )
...
%    generalized Gauss-Hermite quadrature rule and writes it to a file.
%
%    The user specifies:
...
%
  timestamp ( );
  fprintf ( 1, '\n' );
  fprintf ( 1, 'GEN_HERMITE_RULE\n' );
  fprintf ( 1, '  MATLAB version\n' );
  fprintf ( 1, '\n' );
  fprintf ( 1, '  Compute a generalized Gauss-Hermite rule for approximating\n' );
  fprintf ( 1, '    Integral ( -oo < x < +oo ) |x-a|^ALPHA exp(-b*(x-a)^2) f(x) dx\n' );
